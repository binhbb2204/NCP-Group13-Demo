-- MySQL initialization SQL for `chat_sys` (created from original dump)

CREATE DATABASE IF NOT EXISTS `chat_sys` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `chat_sys`;
